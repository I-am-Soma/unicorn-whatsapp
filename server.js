...
// 🌐 Test
app.get('/', (req, res) => {
  res.send('🟢 Unicorn AI Backend activo');
});

// 🔁 Polling cada 10 segundos para responder desde Vapi
  ...
  try {
    ...
    for (const mensaje of pendientes) {
      ...
      try {
        ...
        console.log(`📤 Enviado a Vapi -> ${lead_phone}:`, vapiResponse.data);
    ...
    console.error('🔥 Error en ciclo de procesamiento:', err.message);
  }
};
